...
public class c9_ExecutionControl extends ExecutionControlBase {
    ...
    public void slow_down_there_buckaroo() {
        ...
        Flux<String> notifications = readNotifications()
            // .delayElements(Duration.ofSeconds(1)) // delay next line printing and assertThread calling
            .doOnNext(System.out::println)
            .delayElements(Duration.ofSeconds(1)) // do not affect previous line printing but delay assertThread calling
        ;
